...
#endif
{
    ...
    state->createAndAddParameter("drive", "Drive", "Drive", juce::NormalisableRange<float>(0.001f, 1.0f, 0.0001), 1.0, nullptr, nullptr);
    state->createAndAddParameter("range", "Range", "Range", juce::NormalisableRange<float>(1.0f, 3000.0f, 0.001), 1.0, nullptr, nullptr);
    //DIRE AD ALE IL CAMBIO DI RANGE
    state->createAndAddParameter("blend", "Blend", "Blend", juce::NormalisableRange<float>(0.01f, 1.0f, 0.0001), 1.0, nullptr, nullptr);
    state->createAndAddParameter("volume", "Volume", "Volume", juce::NormalisableRange<float>(0.0f, 3.0f, 0.0001), 1.0, nullptr, nullptr);
    ...
    //REVERB/DELAY
    state->createAndAddParameter("drywet", "DryWet", "DryWet", juce::NormalisableRange<float>(0.001f, 1.0f, 0.0001), 1.0, nullptr, nullptr);
    state->createAndAddParameter("size", "Size", "Size", juce::NormalisableRange<float>(0.001f, 1.0f, 0.0001), 1.0, nullptr, nullptr);
    state->createAndAddParameter("effect", "Effect", "Effect", juce::NormalisableRange<float>(1.f, 2.f, 1.0), 1.0, nullptr, nullptr);

    //FILTER
    state->createAndAddParameter("cutoff", "Cutoff", "Cutoff", juce::NormalisableRange<float>(20.f, 20000.0f, 1.0), 440.0, nullptr, nullptr);
    state->createAndAddParameter("resonance", "Resonance", "Resonance", juce::NormalisableRange<float>(1.f, 10.0f, 1.0), 1.0, nullptr, nullptr);
